...
(
	...
	"		TASK_METROPOLICE_KICK_LAUNCH		0"				// [MODIFICATION] 4. Plays the kick animation sequence.
	"		TASK_METROPOLICE_PLAY_KICK_ANIMATION		0"		// [MODIFICATION] 5. Applies the physical kick force to the memorized grenade.
	""
	"	Interrupts"
)
